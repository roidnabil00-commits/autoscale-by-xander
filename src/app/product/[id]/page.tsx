...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] pt-20 sm:pt-28 pb-20">
      {/* Wrapper utama dengan padding yang konsisten */}
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/*
          Layout:
          - Mobile  : 1 kolom, galeri di atas, form checkout di bawah
          - Desktop : 2 kolom berdampingan (7:5)
        */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-7">
            ...
            <div className="bg-white p-3 sm:p-4 rounded-2xl border border-gray-100 shadow-sm">
              <div className="aspect-[16/10] bg-gray-100 rounded-xl overflow-hidden mb-3 flex items-center justify-center">
            ...
            <div className="bg-white p-5 sm:p-7 rounded-2xl border border-gray-100 shadow-sm">
              <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-3 border-b border-gray-100 pb-3">
                Tentang Produk Ini
              </h3>
          ...
          <div className="lg:col-span-5">
            {/*
              Di mobile: card biasa (tidak sticky)
              Di desktop: sticky saat scroll
            */}
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        type="text" name="referral" value={formData.referral} onChange={handleInputChange}
